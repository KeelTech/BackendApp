...
use Merkulove\LottierElementor\Unity\Cache;
use Merkulove\LottierElementor\Unity\Helper;
use Merkulove\LottierElementor\Unity\Plugin;
use Merkulove\LottierElementor\UninstallHelper;
use Merkulove\LottierElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_lottier_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_lottier_elementor_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_lottier_elementor_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
