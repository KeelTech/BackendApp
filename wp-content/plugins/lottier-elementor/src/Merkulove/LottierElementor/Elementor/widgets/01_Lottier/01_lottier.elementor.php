 ...
 **/
	 ...
	 **/
	final class lottier_elementor extends Widget_Base {
		...
		public function __construct( $data = [], $args = null ) {
			...
			wp_register_style('mdp-lottier-css', LottierElementor::$url . 'css/lottier' . LottierElementor::$suffix . '.css', [], LottierElementor::$version );
			wp_register_style('mdp-lottier-elementor-widget-css', LottierElementor::$url . 'css/elementor-admin' . LottierElementor::$suffix . '.css', [], LottierElementor::$version );
			wp_register_script( 'lottie-player', LottierElementor::$url . 'js/lottie-player' . LottierElementor::$suffix . '.js', array(), LottierElementor::$version, true);
		}
		...
		public function get_style_depends() {
			return ['mdp-lottier-css', 'mdp-lottier-elementor-widget-css'];
		}
		...
		protected function render() {
            ...
            <script>
                let player_<?php echo esc_attr($idSection); ?> = document.querySelector("#mdp-lottier-<?php echo esc_attr($idSection); ?>");
