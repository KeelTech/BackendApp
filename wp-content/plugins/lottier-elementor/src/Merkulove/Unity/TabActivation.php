	...
	public function render_subscribe() {
        ...
        <div class="mdp-subscribe-form">
            ...
            <p class="mdp-subscribe-form-message"
               data-success="<?php esc_html_e( 'Hurray! We received your Subscription request. Check your inbox for an email from us.', 'lottier-elementor' ); ?>"
               data-warn="<?php esc_html_e( 'Oh! Sorry, but we cannot send messages to this email.', 'lottier-elementor' ); ?>"
               data-error="<?php esc_html_e( 'Oops! Something went wrong. Please try later.', 'lottier-elementor' ); ?>"
            ></p>
            ...
            <div class="mdc-accordion" data-mdp-accordion="showfirst: true">
                ...
                <div class="mdc-accordion-content">
                    <p>
                        ...
                        <a href="https://merkulove.zendesk.com/hc/en-us/articles/360006100998-Troubleshooting-of-the-plugin-activation" target="_blank"><?php esc_html_e( 'Purchase Code is Not Working', 'lottier-elementor' );?></a>
                        <?php esc_html_e( ' .', 'lottier-elementor');?>
                    </p>
                </div>
