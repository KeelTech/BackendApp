...
if ( ! class_exists( 'YITH_WCAF_Shortcode' ) ) {
	...
	class YITH_WCAF_Shortcode {
		 ...
		 * @param string $content Content to show, if conditions are matched.
		 *
		 * @return string Shortcode content
		 * @since 1.0.0
		 */
		public static function show_if_affiliate( $atts = array(), $content = '' ) {
			 ...
			 */
			$defaults = array(
				'show_to' => 'enabled_affiliates', // valid_affiliates/ enabled_affiliates / all_affiliates / {user role} / logged_in_users / anyone.
			);
		...
		public static function affiliate_dashboard_commissions( $atts = array() ) {
			...
			$atts = array_merge(
				...
				array(
					...
					'affiliate'                  => $affiliate,
					'commissions'                => apply_filters( 'yith_wcaf_commissions_dashboard_commissions', $commissions ),
		...
		public static function affiliate_dashboard_summary( $atts = array() ) {
			...
			$greeting_message = apply_filters( 'yith_wcaf_dashboard_greeting_message', $greeting_message, $user );
