			...
			<?php if ( ! empty( $commissions ) ) : ?>
				<?php foreach ( $commissions as $commission ) : ?>
					<tr>
						...
						<td class="commission-rate"><?php echo sprintf ( apply_filters( 'yith_wcaf_display_format', '%1$s%2$s' ), yith_wcaf_number_format( $commission['rate'], 2 ), esc_html( apply_filters( 'yith_wcaf_display_symbol', '%' ) ) ); ?></td>
