		...
		<div class="filters">
			<form>
				<div class="filters-row">
					<select name="product_id" class="product-search wc-product-search yith-proteo-standard-select" data-placeholder="<?php esc_html_e( 'Product:', 'yith-woocommerce-affiliates' ); ?>" style="display: none;">
				...
				<?php if ( ! empty( $commissions ) ) : ?>
					<?php foreach ( $commissions as $commission ) : ?>
						<tr>
							...
							<td class="column-rate"><?php echo sprintf ( apply_filters( 'yith_wcaf_display_format', '%1$s%2$s' ), yith_wcaf_number_format( $commission['rate'], 2 ), esc_html( apply_filters( 'yith_wcaf_display_symbol', '%' ) ) ); ?></td>
