...
use Merkulove\TimelinerElementor\Unity\Cache;
use Merkulove\TimelinerElementor\Unity\Helper;
use Merkulove\TimelinerElementor\Unity\Plugin;
use Merkulove\TimelinerElementor\UninstallHelper;
use Merkulove\TimelinerElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_timeliner_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_timeliner_elementor_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_timeliner_elementor_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
