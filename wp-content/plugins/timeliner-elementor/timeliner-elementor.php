 ...
 *
 * @wordpress-plugin
 * Plugin Name: Timeliner for Elementor
 * Plugin URI: https://1.envato.market/timeliner-elementor
 * Description: Beautiful graphical representation of a period of time for Elementor
 * Version: 1.0.0
 ...
 * Text Domain: timeliner-elementor
...
use Merkulove\TimelinerElementor\Caster;
use Merkulove\TimelinerElementor\Config;
use Merkulove\TimelinerElementor\Unity\Unity;
 ...
 *
 **/
final class TimelinerElementor {

    /**
     * The one true TimelinerElementor.
     *
     * @var TimelinerElementor
     * @since 1.0.0
     * @access private
     **/
	...
	public static function on_activation() {
        ...
        /** Call Timeliner on plugin activation */
...
register_activation_hook( __FILE__, [ TimelinerElementor::class, 'on_activation' ] );

/** Run 'on_deactivation' when the plugin is deactivated. */
register_deactivation_hook( __FILE__, [ TimelinerElementor::class, 'on_deactivation' ] );

/** Run Plugin class once after activated plugins have loaded. */
add_action( 'plugins_loaded', [ TimelinerElementor::get_instance(), 'setup' ] );
