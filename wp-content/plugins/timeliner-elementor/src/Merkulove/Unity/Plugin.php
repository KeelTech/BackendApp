...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/timeliner-elementor.php';
        ...
        if ( 'elementor' === self::$type ) {
            ...
            self::$menu_bases[] = 'elementor_page_mdp_timeliner_elementor_settings';
            self::$menu_bases[] = 'settings_page_mdp_timeliner_elementor_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_mdp_timeliner_elementor_settings';
            self::$menu_bases[] = 'timeliner_elementor_page_mdp_timeliner_elementor_settings';
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'timeliner-elementor' ),
            'title'         => esc_html__( 'System Status', 'timeliner-elementor' ),
            'show_title'    => true,
            'icon'          => 'info',
            'reports'       => [
                'server'    => [
    ...
    private function add_uninstall_tab() {
        ...
        self::$tabs['uninstall'] = [
            ...
            'label'         => esc_html__( 'Uninstall', 'timeliner-elementor' ),
            'title'         => esc_html__( 'Uninstall Settings', 'timeliner-elementor' ),
            'show_title'    => true,
            'icon'          => 'delete_sweep',
            'fields'        => [
                'delete_plugin' => [
