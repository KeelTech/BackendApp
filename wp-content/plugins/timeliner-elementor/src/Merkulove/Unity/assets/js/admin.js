...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpTimelinerElementor = window.mdpTimelinerElementor;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            let plugin = 'timeliner-elementor';
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                ...
                nonce: mdpTimelinerElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpTimelinerElementor.ajaxURL, data, function( response ) {
