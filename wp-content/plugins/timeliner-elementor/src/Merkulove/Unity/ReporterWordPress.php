...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'timeliner-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'timeliner-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'timeliner-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'timeliner-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'timeliner-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'timeliner-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'timeliner-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'timeliner-elementor' ),
			'language'              => esc_html__( 'Language', 'timeliner-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'timeliner-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'timeliner-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'timeliner-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'timeliner-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'timeliner-elementor' ) : esc_html__( 'No', 'timeliner-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'timeliner-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'timeliner-elementor' ) : esc_html__( 'Inactive', 'timeliner-elementor' )
		];
