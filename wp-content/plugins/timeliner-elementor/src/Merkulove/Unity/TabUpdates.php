...
final class TabUpdates extends Tab {
	...
	public function add_settings() {
        ...
        add_settings_field( 'check_updates', esc_html__( 'Check for updates:', 'timeliner-elementor' ), [$this, 'check_updates'], $group, $section );
    ...
    public function check_updates() {
        ...
        UI::get_instance()->render_button(
            esc_html__( 'Check Updates', 'timeliner-elementor' ),
            '',
            'autorenew',
            [
                "name" => 'mdp_timeliner_elementor_' . self::TAB_SLUG . '_settings' . "[check_updates]",
                "id" => "mdp-updates-btn",
    ...
    public static function ajax_check_updates() {
        ...
        check_ajax_referer( 'timeliner-elementor', 'nonce' );
