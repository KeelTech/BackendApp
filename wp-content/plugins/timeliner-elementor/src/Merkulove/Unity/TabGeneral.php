...
final class TabGeneral extends Tab {
	...
	public function add_settings( $tab_slug ) {
        ...
        $group = 'TimelinerElementor' . $tab_slug . 'OptionsGroup';
        $section = 'mdp_timeliner_elementor_' . $tab_slug . '_page_status_section';
    ...
    private function prepare_attr( $key, $tab_slug, $field ) {
        ...
        $name = 'mdp_timeliner_elementor_' . $tab_slug . '_settings';
