...
final class PluginHelper {
	...
	public function add_row_meta( $links, $file ) {
		...
		$stars = esc_html__( 'Rate this plugin:', 'timeliner-elementor' );
    ...
    public static function load_textdomain() {
        ...
        load_plugin_textdomain( 'timeliner-elementor', false, Plugin::get_path() . '/languages/' );
