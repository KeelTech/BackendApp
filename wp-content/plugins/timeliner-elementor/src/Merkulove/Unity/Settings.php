...
final class Settings {
            ...
            <div class="mdc-drawer__content">
                <nav class="mdc-list">
					...
					foreach ( $tabs as $tab => $value ) {
						...
						/** Prepare link. */
						$link = '?page=mdp_timeliner_elementor_settings&tab=' . $tab;
	...
	private function add_submenu_elementor() {
        ...
        add_submenu_page(
            $parent,
            esc_html__( 'Timeliner Settings', 'timeliner-elementor' ),
            esc_html__( 'Timeliner for Elementor', 'timeliner-elementor' ),
            'manage_options',
        ...
        <div class="mdc-drawer__header mdc-plugin-fixed">
            <a class="mdc-list-item mdp-plugin-title" href="#">
                <i class="mdc-list-item__graphic" aria-hidden="true">
                    <img src="<?php echo esc_attr( Plugin::get_url() . 'images/logo-color.svg' ); ?>" alt="<?php esc_html_e( 'TimelinerElementor', 'timeliner-elementor' ) ?>">
                </i>
                <span class="mdc-list-item__text">
                    <?php if ( 'wordpress' === Plugin::get_type() ) : ?>
                        <?php esc_html_e( 'Timeliner for Elementor', 'timeliner-elementor' ) ?>
                    <?php else: ?>
                        <?php esc_html_e( 'Timeliner', 'timeliner-elementor' ) ?>
                    <?php endif; ?>
                </span>
                <span class="mdc-list-item__text">
                    <sup>
