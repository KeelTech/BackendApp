...
class CustomerQualificationsLabelSerializer(serializers.ModelSerializer):
    ...
    def get_country(self, obj):
        if "labels" in self.context:
            if obj.country:
                ...
                return {"value": var,  "name":name, "type":"drop-down", "labels":self.context["labels"]["country_label"]}
    ...
    def get_state(self, obj):
        if "labels" in self.context:
            if obj.state:
                ...
                return {"value": var,  "name":name,"type":"drop-down", "labels":self.context["labels"]["state_label"]}
    ...
    def get_city(self, obj):
        if "labels" in self.context:
            if obj.city:
                ...
                return {"value": var,  "name":name, "type":"drop-down", "labels":self.context["labels"]["city_label"]}
    ...
    class Meta:
        ...
        fields = ('id', 'institute', 'year_of_passing', 'degree', 'grade', 'country', 'state', 'city',
                    'start_date', 'end_date', 'labels', 'full_address')
...
class WorkExperienceLabelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'company_name', 'designation', 'job_type', 'job_description', 'weekly_working_hours', 
                    'start_date', 'end_date', 'country', 'state', 'city', 'full_address', 'labels', )
